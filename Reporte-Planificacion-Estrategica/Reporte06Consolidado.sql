...
**/
round(AVG(consolidado.Subtotal_T1),2) Subtotal_T1,
round(AVG(consolidado.Subtotal_T2),2) Subtotal_T2,
round(AVG(consolidado.Subtotal_T3),2) Subtotal_T3,
round(AVG(consolidado.Subtotal_T4),2) Subtotal_T4,
round(AVG(consolidado.acumulado),2 ) Acumulado
from
(select
...
order by 1) trim ) ejes ) consolidado