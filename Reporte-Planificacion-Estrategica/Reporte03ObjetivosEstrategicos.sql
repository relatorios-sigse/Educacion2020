...
COALESCE((
						...
						INNER JOIN STSCSTRUCTITEM AB ON (
								AB.CDSCSTRUCTITEM = OWNER3.CDSCSTRUCTITEM
								AND AB.CDSCORECARD = OWNER3.CDSCORECARD
								AND AB.CDREVISION = OWNER3.CDREVISION
								)
...
GROUP BY id_obj_est,obj_est
order by 1) trim ) objest