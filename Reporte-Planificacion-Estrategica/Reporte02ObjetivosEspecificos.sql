...
COALESCE((
						...
						INNER JOIN STSCSTRUCTITEM AB ON (
								AB.CDSCSTRUCTITEM = OWNER2.CDSCSTRUCTITEM
								AND AB.CDSCORECARD = OWNER2.CDSCORECARD
								AND AB.CDREVISION = OWNER2.CDREVISION
								)
...
GROUP BY id_obj_esp,obj_esp
order by 1) trim ) objesp